...
- `CG-021` as the next Milestone B step, expanding full-pipeline regression coverage on top of the completed detonation telemetry and CLI foundations.
